  ...
  <div class="setup-view">
          ...
          <div class="instruction-steps">
            <div class="step">
              ...
              <div class="step-content">
                ...
                <code>tag-manager setup assume-role --deploy</code>
            ...
            <div class="step">
              ...
              <div class="step-content">
                ...
                <code>tag-manager setup multi-account</code>
            ...
            <div class="step">
              ...
              <div class="step-content">
                ...
                <code>tag-manager setup assume-role --status</code>
    ...
    <div class="section-card">
      ...
      <div class="cli-commands">
        <div class="cli-group">
          <h4>Initial Setup</h4>
          <div class="cli-cmd"><code>tag-manager setup wizard</code><span>Interactive setup wizard</span></div>
          <div class="cli-cmd"><code>tag-manager setup validate</code><span>Validate configuration</span></div>
          <div class="cli-cmd"><code>tag-manager setup validate --iam</code><span>Show required IAM permissions</span></div>
          <div class="cli-cmd"><code>tag-manager setup doctor</code><span>Diagnose installation issues</span></div>
        </div>
        <div class="cli-group">
          <h4>AWS Configuration</h4>
          <div class="cli-cmd"><code>tag-manager setup aws</code><span>Configure AWS profile</span></div>
          <div class="cli-cmd"><code>tag-manager setup database</code><span>Initialize database</span></div>
          <div class="cli-cmd"><code>tag-manager setup database --force</code><span>Reset and reinitialize database</span></div>
        </div>
        <div class="cli-group">
          <h4>Multi-Account</h4>
          <div class="cli-cmd"><code>tag-manager setup multi-account</code><span>Deploy cross-account StackSets</span></div>
          <div class="cli-cmd"><code>tag-manager setup assume-role --deploy</code><span>Configure assume-role auth</span></div>
          <div class="cli-cmd"><code>tag-manager setup assume-role --status</code><span>Check role configuration</span></div>
        </div>
      </div>
    </div>
